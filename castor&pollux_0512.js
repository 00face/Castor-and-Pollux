...
// Upgrades: Chunked Zip Exports because wow, Regex search in Pollux, Expanded SFT Taxonomies.
///////////////////////////////////////////////////
...
(function () {
    ...
    const castorSteps = [
        ...
        { sel: '#gae-sel-focus', txt: "Adjust parsing focus. For example, 'Code' or 'Security' enforces rigid technical formatting on output." },
...
<body data-theme="dark">
    ...
    <header role="banner">
        ...
        <nav class="controls" aria-label="Main Navigation Controls">
            ...
            <div class="search-wrapper">
                <input type="text" id="searchInput" name="searchInput" aria-label="Search through archived records. Wrap in / to use Regex." placeholder="Search matrices...">
            </div>
    ...
    <script>
        ...
        const polluxSteps = [
            { sel: '#searchInput', txt: "Search across all loaded extraction matrices instantly. Supports /regex/i patterns." },
