// castor&pollux.js w/comments
// Latest Additions: Baseline Chassis, Hardened Phase-0 Quota Intercept, Strict-Left Tour Guide, API Sourcing Integrations.
// Latest Upgrades: Chunked Zip Exports, Multi-modal Vision API, Regex Search in Pollux, Expanded SFT Taxonomies.
///////////////////////////////////////////////////
        ...
        run() {
            ...
            this.tmr = setInterval(() => {
                ...
                if (t) {
                    ...
                    if (left < 10) {
                        left = 10;
                        if (r.bottom + 180 < wh) top = (r.bottom + 15) | 0;
                        else top = (r.top - 180) | 0;
                    }
